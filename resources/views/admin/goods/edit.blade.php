      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              <form method="POST" action="{{ route('admin.goods.update', ['id' => $goods->id]) }}">
                @csrf
                @method('put')
                <div class="form-row">
                  {{-- ID --}}
                  <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" id="id" name="id" value="{{ $goods->id }}" disabled>
                  </div>
                </div>
                <div class="form-row">
                  {{-- Name --}}
                  <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name"
                      value="{{ old('name') ? old('name') : $goods->name }}" rules="required">
                    @error('name')
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control @error('qty') is-invalid @enderror" id="qty" name="qty"
                      value="{{ old('qty') ? old('qty') : $goods->qty }}" rules="required|integer|min:0">
                    @error('qty')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
